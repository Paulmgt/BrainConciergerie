...
const CreateCinema = () => {
    ...
    const handleDeleteCinemas = async (id) => {
        try {
            ...
            if (response.ok) {
                setCinemas((prevCinemas) => prevCinemas.filter((cinemas) => cinemas.id !== id));
                closeDeleteAlert();
            } else {
    ...
    return (
        <Box>
            <Button colorScheme="blue" onClick={onOpen}>Ajouter un cinema</Button>
                    ...
                    {cinemas
                        ...
                        .map((cinema) => (
                            <Tr key={cinema.id}>
                                ...
                                <Td>
                                    <Button colorScheme="red" onClick={() => openDeleteAlert(cinema.id)}>Supprimer</Button>
                                </Td>
                            </Tr>
                        ))}
                </Tbody>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader>Ajouter un nouveau Cinema ou Théatre</ModalHeader>
                    <ModalCloseButton />
                    <form onSubmit={handleSubmit}>
                        <ModalBody>
                            <FormControl>
                                <FormLabel>Nom du cinema</FormLabel>
            ...
            <AlertDialog isOpen={isDeleteAlertOpen} onClose={closeDeleteAlert} isCentered>
                <AlertDialogOverlay>
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                            <Button colorScheme="red" onClick={() => handleDeleteCinemas(deleteCinemaId)}>
                                Supprimer
                            </Button>
